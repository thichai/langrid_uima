...
public class JServerTranslation implements TranslationService{
	...
	public String translate(String sourceLang, String targetLang, String source)
		...
		try {
			TranslationClient cl = ClientFactory.createTranslationClient(new URL("http://langrid.org/service_manager/invoker/kyoto1.langrid:KyotoUJServer"));
