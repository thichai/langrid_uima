...
public class TwoHopTranslation extends AbstractTranslationService {

	public TwoHopTranslation() {
	...
	private String invokeTranslation(Language sourceLang,
		...
		MultihopTranslationResult result = service.multihopTranslate(sourceLang.getCode(), new String[] {"en"}, targetLang.getCode(), source);
