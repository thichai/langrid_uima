...
public class UIMATranslationCombinedWithDictionary extends
		...
		try {
			...
			req.getTreeBindings()
					.add(new BindingNode("MorphologicalAnalysisPL",
							"http://localhost:8080/jp.go.nict.langrid.webapps.composite/pbServices/UIMACASPoolMorphologicalAnalysis"));
			req.getTreeBindings()
					.add(new BindingNode(
							"TranslationPL",
