 ...
 * @generated */
public class TranslationText_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (TranslationText_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = TranslationText_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new TranslationText(addr, TranslationText_Type.this);
  			   TranslationText_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new TranslationText(addr, TranslationText_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = TranslationText.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.trang.uima.types.TranslationText");
  ...
  public String getFromLang(int addr) {
      ...
      jcas.throwFeatMissing("FromLang", "com.trang.uima.types.TranslationText");
  ...
  public String getToLang(int addr) {
      ...
      jcas.throwFeatMissing("ToLang", "com.trang.uima.types.TranslationText");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("Content", "com.trang.uima.types.TranslationText");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public TranslationText_Type(JCas jcas, Type casType) {
    super(jcas, casType);
