...
public class Target_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.trang.uima.types.Target");
  ...
  public String getFromLang(int addr) {
      ...
      jcas.throwFeatMissing("FromLang", "com.trang.uima.types.Target");
  ...
  public String getToLang(int addr) {
      ...
      jcas.throwFeatMissing("ToLang", "com.trang.uima.types.Target");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("Content", "com.trang.uima.types.Target");
